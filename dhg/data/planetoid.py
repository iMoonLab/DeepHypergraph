...
class Cora(BaseData):
    r"""A citation network dataset for vertex classification task. More details can be found in this `websit <https://relational.fit.cvut.cz/dataset/CORA>`_.
...
class Citeseer(BaseData):
    r"""A citation network dataset for vertex classification task. More details can be found in this `websit <https://relational.fit.cvut.cz/dataset/CiteSeer>`_.
...
class Pubmed(BaseData):
    r"""A citation network dataset for vertex classification task. More details can be found in this `websit <https://pubmed.ncbi.nlm.nih.gov/download/>`_.
