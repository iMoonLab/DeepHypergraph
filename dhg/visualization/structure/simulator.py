...
class Simulator:
    ...
    def __init__(self, nums, forces, n_centers=1, damping_factor=0.95) -> None:
    ...
    def simulate(self, init_position, H, max_iter=500, epsilon=0.001, dt=0.01) -> None:
        """
    ...
    def _step(self, position, velocity, H, epsilon, damping, dt):
        ...
        if self.n_centers == 1:
            ...
            centers = [np.array((cos(2 * pi * i / self.n_centers), sin(2 * pi * i / self.n_centers))) for i in range(self.n_centers)]
